...
import com.tandera.controle.ControleCA_0000;
 ...
 * @author alex.lopes
 */
public class CA_0000 extends javax.swing.JInternalFrame {

    ConectaBanco conexao = new ConectaBanco();
    ModeloCA_0000 modelo = new ModeloCA_0000();
    ControleCA_0000 control = new ControleCA_0000();
    int muda = 1;

    /**
     * Creates new form CA_0000
     */
    public CA_0000() {
        initComponents();
        conexao.conexao();
        preencherTabela("select * from grupos order by id_grupo");
    ...
    private void jButtonIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonIncluirActionPerformed
        if (muda == 1) {
            ...
            modelo.setHireData(new java.sql.Timestamp(new java.util.Date().getTime()));
            control.InserirCA_0000(modelo);
            preencherTabela("select * from grupos order by id_grupo");
        } else {
            modelo.setDescr(jTextFieldDescr.getText());
            modelo.setHireData(new java.sql.Timestamp(new java.util.Date().getTime()));
            control.AlteraCA_0000(modelo);
            preencherTabela("select * from grupos order by id_grupo");
        }
        jTextFieldCod.setText("");
        jTextFieldDescr.setText("");
    ...
    public void preencherTabela(String SQL) {
        ...
        try {
            conexao.rs.first();
            do {
                dados.add(new Object[]{conexao.rs.getInt("id_grupo"), conexao.rs.getString("descr_grupo")});
        ...
        tabela.getColumnModel().getColumn(0).setPreferredWidth(56);
        tabela.getColumnModel().getColumn(0).setResizable(false);
        tabela.getColumnModel().getColumn(1).setPreferredWidth(386);
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        ...
        conexao.conexao();
        conexao.executaSQL("select * from grupos where id_grupo =" + descr);
        try {
            conexao.rs.first();
            jTextFieldCod.setText(String.valueOf(conexao.rs.getInt("id_grupo")));
            jTextFieldDescr.setText(conexao.rs.getString("descr_grupo"));
