...
import com.tandera.controle.ControleCA_0201;
 ...
 * @author alex.lopes
 */
public class CA_0201 extends javax.swing.JInternalFrame {

    ConectaBanco conexao = new ConectaBanco();
    ModeloCA_0201 modelo = new ModeloCA_0201();
    ControleCA_0201 control = new ControleCA_0201();
    int muda = 1;

    /**
     * Creates new form CA_0202
     */
    public CA_0201() {
        initComponents();
        conexao.conexao();
        preencherTabela("select * from computador order by id_com");
    ...
    private void initComponents() {
        ...
        jTextFieldProcessador.setDisabledTextColor(new java.awt.Color(0, 0, 51));
        jTextFieldProcessador.setEnabled(false);

        jLabel6.setText("MAC:");

        jTextFieldMac.setDisabledTextColor(new java.awt.Color(0, 0, 51));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jTextFieldMac, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        ...
        conexao.conexao();
        conexao.executaSQL("select * from computador where id_com =" + descr);
        try {
            conexao.rs.first();
            jTextFieldCod.setText(String.valueOf(conexao.rs.getInt("id_com")));
            jTextFieldDescr.setText(conexao.rs.getString("descr_com"));
            jTextFieldCP.setText((String.valueOf(conexao.rs.getInt("cp_com"))));
            jTextFieldProcessador.setText(conexao.rs.getString("pro_com"));
            jTextFieldMac.setText(conexao.rs.getString("mac_com"));
    ...
    private void jButtonIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonIncluirActionPerformed
        if (muda == 1) {
            ...
            modelo.setProc(jTextFieldProcessador.getText());
            modelo.setMac(jTextFieldMac.getText());
            control.InserirCA_0201(modelo);
            preencherTabela("select * from computador order by id_com");
        } else {
            modelo.setDescr(jTextFieldDescr.getText());
            modelo.setCp(Integer.parseInt(jTextFieldCP.getText()));
    ...
    public void preencherTabela(String SQL) {
        ...
        try {
            conexao.rs.first();
            do {
                dados.add(new Object[]{conexao.rs.getInt("id_com"), conexao.rs.getString("descr_com"), conexao.rs.getString("cp_com")});
